...
// Interface for Lead operations
class ILead {
public:
    virtual void addLead() = 0;
    virtual void modifyLead() = 0;
    virtual void searchLeadsByName() = 0;
    virtual void displayAllLeads() = 0;
    virtual ~ILead() = default;
};

// Interface for Contact operations
class IContact {
public:
    virtual void addContactToLead() = 0;
    virtual void modifyContact() = 0;
    virtual void searchContactsByName() = 0;
    virtual void displayAllContacts() = 0;
    virtual ~IContact() = default;
};

// Interface for file and memory management
...
// Contact class definition remains unchanged.
class Contact {
private:
    int _id;
    string _name;
...
// Lead class definition remains unchanged.
class Lead {
private:
    int _id;
    string _name;
...
// CRM class implementing the interfaces
class CRM : public ILead, public IContact, public IDataPersistence {
private:
    List<Lead> leadList;
    List<Contact> contactList;
    int leadCounter = 0;
...
public:
    // Implement ILead interface
    void addLead() override {
    ...
    void searchLeadsByName() override {
        string leadName;
        cout << "Enter Lead Name to search: ";
        cin.ignore();
        getline(cin, leadName);
    ...
    // Implement IContact interface
    void addContactToLead() override {
        string leadName;
        cout << "Enter Lead Name to search: ";
        cin.ignore();
        getline(cin, leadName);
    ...
    void searchContactsByName() override {
        string contactName;
        cout << "Enter Contact Name to search: ";
        cin.ignore();
        getline(cin, contactName);
    ...
    void saveDataToFile() override {
        ofstream leadFile("leads4.txt");
        ofstream contactFile("contacts4.txt");
    ...
    void loadDataFromFile() override {
        ifstream leadFile("leads4.txt");
        ifstream contactFile("contacts4.txt");
